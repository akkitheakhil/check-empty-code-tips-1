import { isDataNotEmpty } from "./utils/is-empty";
const formBang: HTMLFormElement = document.querySelector("form#bang");
const inputBang: HTMLInputElement = document.querySelector(
  "input#level-input-bang"
);
const errorBang: HTMLSpanElement = document.querySelector("span.error-bang");
const successBang: HTMLSpanElement =
  document.querySelector("span.success-bang");

const formUtil: HTMLFormElement = document.querySelector("form#util");
const inputUtil: HTMLInputElement = document.querySelector(
  "input#level-input-util"
);
const errorUtil: HTMLSpanElement = document.querySelector("span.error-util");
const successUtil: HTMLSpanElement =
  document.querySelector("span.success-util");
...
formUtil.addEventListener("submit", (e: SubmitEvent) => {
  ...
  if (!isDataNotEmpty(softwareEngineerLevel)) {
